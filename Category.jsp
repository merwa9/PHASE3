...
<head>
<meta charset="UTF-8">
<title>Purchase Report - Sorted by Category</title>
</head>
<body>

<h2>Purchase Report - Sorted by Category</h2>
...
String QueryString = 
"SELECT products.ProductName, products.Price, products.Quantity, products.Catergory, Purchases.ProductName, Purchases.Email, Purchases.PurchaseDate FROM SportyShoes.products LEFT JOIN SportyShoes.Purchases ON products.ProductName = Purchases.ProductName ORDER BY products.Catergory  ; ";
